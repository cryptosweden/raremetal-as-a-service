...
Custodian trust model: metals aren't natively onchain like a wallet balance — you need a trusted (or federated) custodian/assayer to attest "yes, 100oz of 99.99% gold sits in vault X allocated to entity Y." That's an oracle problem, not a pure ZK problem. Here is where AI play big role. AI don't lie and dont steal and are very acurate and precise.
...
This will be done trough photos or videos on a weekly or montly basis of the customers choosing. 
